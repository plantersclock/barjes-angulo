...
const LinkBoxes = () => {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1">
      ...
      <Link href="/for-clients" className=" col-span-1  sm:aspect-square  ">
        <PillarCard
      ...
      <Link href="/for-advisors" className=" col-span-1  sm:aspect-square ">
        <PillarCard
      ...
      <Link href="/speaking" className=" col-span-1  sm:aspect-square  ">
        <PillarCard
