...
const LinkBoxes = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1">
      <Link href="/about" className=" col-span-1 aspect-square  ">
        <PillarCard
      ...
      <Link href="/for-clients" className=" col-span-1 aspect-square  ">
        <PillarCard
      ...
      <Link href="/speaking" className=" col-span-1 aspect-square  ">
        <PillarCard
