        ...
        {submitStatus === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3 mt-10">
            ...
            <button
              ...
              className="w-full lg:max-w-[60%] xl:max-w-[55%] 2xl:max-w-[45%] mt-8 inline-flex items-center gap-2 px-4 2xl:px-6 py-3 sm:py-2 2xl:py-3 text-white text-xs 2xl:text-sm font-semibold uppercase tracking-wide hover:opacity-90 transition-opacity"
              style={{
